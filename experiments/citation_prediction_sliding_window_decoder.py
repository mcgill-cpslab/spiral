        ...
        for r in range(2,3):
            ...
            for trial in range(5):
                ...
                if g == 0:
                    ...
                    gnn = GAT([8,4,1], in_dim, hidden_dim,  activation=activation_f,allow_zero_in_degree=True)
                else:
                ...
                if r == 0:
                    sa = SelfAttention( 3, hidden_dim, [16], n_nodes, 7, output_decoder)
                elif r == 1:
                    sa = PTSA( 3, hidden_dim, [16], n_nodes, 7, output_decoder)
                elif r == 2:
                    sa = FTSA( 3, hidden_dim, [16], n_nodes, 7,3,'sum', output_decoder)
                else:
                    pass
                ...
                for epoch in range(epochs):
                    ...
                    if epoch > 10:
                        mini = min(eval_loss)
                        if all(eval_loss[-20:] > mini) or all(np.absolute(eval_loss[-20:] - mini) < 1e-6):
                            print(mini)
                            break
