...
if __name__ == '__main__':
    device = 'cpu'
    logger = logging.getLogger('citation_predictoin_pipeline')
    ...
    logger.info(f"number of snapshots: {n_snapshot}")
    ...
    decoder = LSTM( hidden_dim, 10,n_nodes,device)
    ...
    for epoch in range(200):
        ...
        for t in range(5,len(this_graph)-1):
            this_model.train()
            optimizer.zero_grad()
